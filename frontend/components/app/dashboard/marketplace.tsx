...
function Market() {
  return (
    <div className="p-2 md:p-10 md:rounded-tl-2xl border border-neutral-200 dark:border-neutral-700 h-screen bg-white dark:bg-neutral-900 flex flex-col gap-2 flex-1 w-full backdrop-blur-xl">
      <h1 className="font-semibold logo text-lg py-2">Marketplace</h1>
      <p className="title">Community marketplace will be launched soon!</p>
      ...
      <p className="title mt-4">
        Buy and sell your farm produce, tools, and knowledge with crypto on the
        pamojaFI marketplace
      </p>
    </div>
  );
}
